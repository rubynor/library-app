...
class WishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wish" do
    assert_difference("Wish.count") do
      post wishes_url, params: { wish: { author: @wish.author, title: @wish.title, user_id: @wish.user_id } }
    end
  ...
  test "should update wish" do
    patch wish_url(@wish), params: { wish: { author: @wish.author, title: @wish.title, user_id: @wish.user_id } }
